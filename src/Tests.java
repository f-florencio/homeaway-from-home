...
public class Tests {
    ...
    public static void cleanupFiles() {
        File root = new File("/Users/francisco/IdeaProjects/Campus_Project_DS");
        System.out.println("Diretório de limpeza: " + root.getAbsolutePath());
        ...
        for (String fileName : filesToDelete) {
            ...
            if (f.exists() && f.isFile()) {
                ...
                if (!deleted) {
                    System.err.println("Não foi possível apagar: " + f.getName());
                } else {
